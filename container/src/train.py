...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr_actor', type=float, default=0.00039, help='actor learning rate (default: 0.00039)')
    parser.add_argument('--lr_critic', type=float, default=0.0036, help='critic learning rate (default: 0.0036)')
